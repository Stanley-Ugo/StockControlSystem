...
namespace StockControlSystem.StockControlContext
{
    public class StockControlDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<St_Stkjournal>().HasKey(st_stkjournal => new
            {
                st_stkjournal.Stk_Coy,
                st_stkjournal.Stk_Branch,
                st_stkjournal.Stk_Year,
                st_stkjournal.Stk_Month,
                st_stkjournal.Stk_Loc,
                st_stkjournal.Stk_Type,
                st_stkjournal.Stk_Account
            });
